...
(1, 'admin1', 'Administrator', 'PHAT HIEN LOI API1', '60!eH>Rt=d\'-'),
(2, 'meredithpDUNG', 'Meredith Palmer Dung Dung', 'You are the ONE', '[NaZ7RUMbK#O'),
(3, 'nguyendung', 'Nguyen Trong Dung', 'Sketching for Dummies', '/&T=_yEA5,_L'),
(4, 'hoangmichael', 'Michael Hoang', 'Art of Pranks', 'ag4|YY~`M=Gk');
...
(2, 'hauck.aletha@yahoo.com', 'kU-wDE7r', 'Tara', '1Nkoz6quzJiis1SEonJeSxwkXTzSzcULofbL9O7KPz6_sKGkUcQDzoNfI5aA', 'PHAT HIEN LOI API2', 'Delhi', 'India'),
...
(4, 'hoatrodun@gmail.com', 'zTyBwV/9', 'Evelyn', 'Fp0r1mty_gxK9DRZ5IUw3sX2enQ6rau68M6YGyoqR3XoBG13wtSbvmdaK5CB', 'Bien Hoa', 'Bien Hoa', 'Viet Nam');
...
(1, '1', 'PHAT HIEN LOI API3', '45.5426274', '-122.7944111', 'TEST COMMENT POST', 'baduser007');
...
(1, 'FZvjaFlMgUfnpFJDhKx-92xeXx_sCr7Y', 'john', 'PHAT HIEN LOI API4');
...
(1, 'admin', 'admin!@#$', 'Admin User', 'PHAT HIEN LOI API5', '8080808080');
...
(1, 'admin', 'z2Eav@j6A:^}fSMe', 'oWsZ8vWNuECjCAiZVJHOzsNsNH08zWRZ', 'PHAT HIEN LOI API8');
...
(1, 'richardbranson', '1655', 'PHAT HIEN LOI API9');
